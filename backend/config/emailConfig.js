...
<head>
  <title>Welcome to Authify</title>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="padding: 0 0 10px; font-size: 14px; line-height: 150%;">
                          Hi <span style="color: #4C83EE;"><b>{{name}}</b></span>,
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 0 0 16px; font-size: 14px; line-height: 150%;">
                          Thank you for registering with <strong>Authify</strong>! We're excited to have you on board. Your account has been successfully created.
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td style="padding: 16px 0 0; font-size: 14px; line-height: 150%; color: #555;">
                          Cheers,<br/>
                          The Authify Team
                        </td>
                      </tr>
